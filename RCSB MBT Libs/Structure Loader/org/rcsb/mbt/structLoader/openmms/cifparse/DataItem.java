//
// DataItem.java,v 1.3 2001/10/27 02:02:47 dsg Exp
//
...
/**
 * Stores the information about a single cif Data Item defined in a
 * dictionary.
 *
...
public class DataItem
{
  ...
  public DataItem(final String iname)
    {
      this.itemName = iname;
    }
  ...
  public void setItemDefaultValue(final String defaultval)
    {
      this.itemDefaultValue = defaultval;
    }
  ...
  public void setFieldCode(final int fc)
    {
      this.fieldCode = fc;
    }
  ...
  public void setCatLoader(final CatLoader cl)
    {
      this.catLoader = cl;
    }
