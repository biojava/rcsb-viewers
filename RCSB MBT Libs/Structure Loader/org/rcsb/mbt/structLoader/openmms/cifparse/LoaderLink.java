//
// LoaderLink.java,v 1.3 2001/10/27 02:02:48 dsg Exp
//
...
/**
 * This class is used to bind the Cif Category/Item to the Loader class
 * which handles data for that item
 *
...
public class LoaderLink
{
  ...
  public LoaderLink(final String cn, final String in, final CatLoader cl, final int fc)
    {
      this.catName = cn;
      this.itemName = in;
      this.catLoader = cl;
