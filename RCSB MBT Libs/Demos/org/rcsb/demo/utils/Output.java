...
public class Output
{
	static private final int indentSize = 4;
	private String indent = "";
	private String indentBuf = null;
	
	private PrintStream outStrm;
	
	/**
	 * Constructor - sets the output stream
	 * @param _outStrm - a PrintStream object
	 */
	public Output(PrintStream _outStrm) { outStrm = _outStrm; }
	...
	{
		outStrm.println(line.length() == 0? "" : indent + line);
	}
}
