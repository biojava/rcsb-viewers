...
public class Hermite {
	...
	if( (this.v1 != null) && (this.v2 != null) && (this.n1 != null) && (this.n2 != null) ) {
	    ...
	    System.out.println( "Distance (" + d.coordinates[0] + " " + d.coordinates[1] + " " + d.coordinates[2] + " )" );
	    System.out.println( "First tangent (" + this.vv1.coordinates[0] + " " + this.vv1.coordinates[1] + " " + this.vv1.coordinates[2] + " )" );
	    System.out.println( "Second tangent (" + this.vv2.coordinates[0] + " " + this.vv2.coordinates[1] + " " + this.vv2.coordinates[2] + " )" );
	    System.out.println( "First normal (" + this.n1.coordinates[0] + " " + this.n1.coordinates[1] + " " + this.n1.coordinates[2] + " )" );
	    System.out.println( "Second normal (" + this.n2.coordinates[0] + " " + this.n2.coordinates[1] + " " + this.n2.coordinates[2] + " )" );
	    System.out.println( "First binormal (" + b1.coordinates[0] + " " + b1.coordinates[1] + " " + b1.coordinates[2] + " )" );
	    System.out.println( "Second binormal (" + b2.coordinates[0] + " " + b2.coordinates[1] + " " + b2.coordinates[2] + " )" );
	    System.out.println( );
...
//	    r2 = 0.82f;
	    ...
	    this.vv1.scale( r1 );
	    this.vv2.scale( r2 );
	    this.v1.value[0] = this.vv1.coordinates[0];
	    this.v1.value[1] = this.vv1.coordinates[1];
	    this.v1.value[2] = this.vv1.coordinates[2];
	    this.v2.value[0] = this.vv2.coordinates[0];
	    this.v2.value[1] = this.vv2.coordinates[1];
	    this.v2.value[2] = this.vv2.coordinates[2];	    
	...
	tv2 = 3.0f*t2 - 2.0f*t;
	toReturn.coordinates[0] =  this.p1.value[0]*tp1 + this.p2.value[0]*tp2 + this.v1.value[0]*tv1 + this.v2.value[0]*tv2;
	toReturn.coordinates[1] =  this.p1.value[1]*tp1 + this.p2.value[1]*tp2 + this.v1.value[1]*tv1 + this.v2.value[1]*tv2;
	toReturn.coordinates[2] =  this.p1.value[2]*tp1 + this.p2.value[2]*tp2 + this.v1.value[2]*tv1 + this.v2.value[2]*tv2;
	...
	tv1  = 6*t-4;
	tv2 = 6*t-2;
	derivative2.coordinates[0] = tp*(this.p2.value[0] - this.p1.value[0]) + tv1*this.v1.value[0] + tv2*this.v2.value[0];
	derivative2.coordinates[1] = tp*(this.p2.value[1] - this.p1.value[1]) + tv1*this.v1.value[1] + tv2*this.v2.value[1];
	derivative2.coordinates[2] = tp*(this.p2.value[2] - this.p1.value[2]) + tv1*this.v1.value[2] + tv2*this.v2.value[2];
	...
	this.p1 = new Vec3f( start.value[0], start.value[1], start.value[2] );
	this.p2 = new Vec3f( finish.value[0], finish.value[1], finish.value[2] );
	this.v1 = new Vec3f( tangent1.coordinates[0], tangent1.coordinates[1], tangent1.coordinates[2] );
	this.v2 = new Vec3f( tangent2.coordinates[0], tangent2.coordinates[1], tangent2.coordinates[2] );
	...
	this.p1 = new Vec3f( start.coordinates[0], start.coordinates[1], start.coordinates[2] );
	this.p2 = new Vec3f( finish.coordinates[0], finish.coordinates[1], finish.coordinates[2] );
	this.v1 = new Vec3f( tangent1.coordinates[0], tangent1.coordinates[1], tangent1.coordinates[2] );
	this.v2 = new Vec3f( tangent2.coordinates[0], tangent2.coordinates[1], tangent2.coordinates[2] );
