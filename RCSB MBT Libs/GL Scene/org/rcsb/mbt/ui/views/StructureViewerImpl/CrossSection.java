...
public class CrossSection {
  ...
  public void averageNormals() {
	...
	//j = (i+1)%(vertexCount-1);
      ...
      normal[j].value[0] = vectorNormal[j].coordinates[0];
      normal[j].value[1] = vectorNormal[j].coordinates[1];
      normal[j].value[2] = vectorNormal[j].coordinates[2];
    }
      */
	  ...
	  this.normal[j].value[0] = this.vectorNormal[j].coordinates[0];
	  this.normal[j].value[1] = this.vectorNormal[j].coordinates[1];
	  this.normal[j].value[2] = this.vectorNormal[j].coordinates[2];
      }
  }
