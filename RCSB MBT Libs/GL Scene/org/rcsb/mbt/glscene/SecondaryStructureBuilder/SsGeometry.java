	...
	public static DisplayLists[] createSs(final Chain c,
		...
		for (int fIndex = 0; fIndex < fragmentCount; fIndex++) {
			...
			if (conformationType == ComponentType.UNDEFINED_CONFORMATION) {
				...
				hasLeading = false;
				hasTrailing = false;
				cGeom = new org.rcsb.mbt.glscene.SecondaryStructureBuilder.CoilGeometry(fragment);
				...
				hasLeading = false;
				hasTrailing = false;
				tGeom = new org.rcsb.mbt.glscene.SecondaryStructureBuilder.CoilGeometry(fragment);
				...
				hasTrailing = false;
				manageable = true;
				sGeom = new org.rcsb.mbt.glscene.SecondaryStructureBuilder.StrandGeometry(fragment);
				...
				hGeom = new org.rcsb.mbt.glscene.SecondaryStructureBuilder.HelixGeometry(fragment);
