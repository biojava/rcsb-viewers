...
//  ATOM      3  C   ALA A  13      24.276   5.552   9.942  1.00 43.61           C
 ...
 //       reader.readPly("test/org/rcsb/mbt/surface/EDTSurf Testruns/1atom_vdw_nosmooth.ply");
        reader.readPly("test-input/SurfaceTest/1atom_vdw_nosmooth.ply");
 ...
 //       surface.computenorm();
   ...
   //     writer.outputply(surface, "test/org/rcsb/mbt/surface/Testoutput/1atom_vdw.ply");
        writer.outputply(surface, "test-output/SurfaceTest/1atom_vdw_nosmooth.ply");
    }
...
//        surface.computenorm();
    ...
    public void testVS4() {
        ...
        Sphere sphere2 = new Sphere(new Point3f(0.5f, 0, 0), 2.0f);
