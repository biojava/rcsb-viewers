//  $Id: Turn.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  Revision 1.2  2003/04/23 17:40:36  moreland
...
//
//  Revision 1.1  2002/12/16 06:24:42  moreland
	...
	implements java.lang.Cloneable
{
	...
	/**
	 *  Creates a new Conformation object.
	 */
	public Turn( )
	{
	}
	...
	public static String getClassName()
	{
		if ( Turn.className == null ) {
			Turn.className = Turn.class.getName();
		}
	...
	public void copy( final StructureComponent structureComponent )
	{
		...
		// Turn turn = (Turn) structureComponent;
		// localField       = turn.localField;
	}
