//  $Id: AtomLabelByChainId.java,v 1.1 2007/02/08 02:38:51 jbeaver Exp $
//
	...
	implements IAtomLabel
{
	 ...
	 */
	public static AtomLabelByChainId create( )
	{
		if ( AtomLabelByChainId.singleton == null ) {
			AtomLabelByChainId.singleton = new AtomLabelByChainId( );
		}
		return AtomLabelByChainId.singleton;
	}
