//  $Id: FragmentFormLadder.java,v 1.1 2007/02/08 02:38:51 jbeaver Exp $
//
	...
	implements FragmentForm
{
	 ...
	 */
	public static FragmentFormLadder create( )
	{
		if ( FragmentFormLadder.singleton == null ) {
			FragmentFormLadder.singleton = new FragmentFormLadder( );
		}
		return FragmentFormLadder.singleton;
	}
	...
	{
		return FragmentFormLadder.NAME;
	}
}
