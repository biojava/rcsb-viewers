//  $Id: BondLabelByDistance.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: BondLabelByDistance.java,v $
	...
	implements BondLabel
{
	...
	{
		if ( BondLabelByDistance.singleton == null ) {
			BondLabelByDistance.singleton = new BondLabelByDistance( );
		}
		return BondLabelByDistance.singleton;
	}
	...
	{
		return String.valueOf( bond.getDistance() );
	}
}
