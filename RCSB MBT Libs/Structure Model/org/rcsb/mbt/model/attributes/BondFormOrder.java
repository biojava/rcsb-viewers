//  $Id: BondFormOrder.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
	...
	implements BondForm
{
	...
	{
		if ( BondFormOrder.singleton == null ) {
			BondFormOrder.singleton = new BondFormOrder( );
		}
		return BondFormOrder.singleton;
	}
