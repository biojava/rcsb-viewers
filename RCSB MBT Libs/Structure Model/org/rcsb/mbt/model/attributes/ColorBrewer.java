...
public enum ColorBrewer {
	 BrBG (1, "Brown-Blue-Green", new int[][]{
			 {0xD8B365},
			 {0xD8B365, 0x5AB4AC},
	 ...
	 PiYG (1, "Magenta-Yellow-Green", new int[][]{
			 {0xE9A3C9},
			 {0xE9A3C9, 0xA1D76A},
	 ...
	 PRGn (1, "Purple-Red-Green", new int[][]{
			 {0xAF8DC3},
	         {0xAF8DC3, 0x7FBF7B},
   ...
   RdYlBu (1, "Red-Yellow-Blue", new int[][]{ 
		     {0xFC8D59},
	         {0xFC8D59, 0x91BFDB},
   ...
   RdYlGn (1, "Red-Yellow-Green", new int[][]{
		     {0xFC8D59},
	         {0xFC8D59, 0x91CF60},
 ...
 Spectral (1, "Spectral colors", new int[][]{
		     {0xFC8D59},
             {0xFC8D59, 0x99D594},
   ...
   Paired (2, "Paired colors", new int[][]{
		     {0xA6CEE3},
	         {0xA6CEE3, 0xB2DF8A},
  ...
  Pastel1 (2, "Pastel1 colors", new int[][]{
		     {0xFBB4AE},
		     {0xFBB4AE, 0xCCEBC5},
  ...
  Pastel2 (2, "Pastel2 colors", new int[][]{
		     {0xB3E2CD},
	         {0xB3E2CD, 0xCBD5E8},
    ...
    Blues (3, "Blue shades", new int[][]{
     ...
     BuGn (3, "Blue-Green shades", new int[][]{
    		 {0xE5F5F9},
    		 {0xE5F5F9, 0x2CA25F},
     ...
     BuPu (3, "Blue-Purple shades", new int[][]{
    		 {0xE0ECF4},
    		 {0xE0ECF4, 0x8856A7},
     ...
     GnBu (3, "Green-Blue shades", new int[][]{
    		 {0xE0F3DB},
    		 {0xE0F3DB, 0x43A2CA},
  ...
  Oranges (3, "Orange shades", new int[][]{
		     {0xFEE6CE},
		     {0xFEE6CE, 0xE6550D},
     ...
     OrRd (3, "Orange-Red shades", new int[][]{
    		 {0xFEE8C8},
    		 {0xFEE8C8, 0xE34A33},
     ...
     PuBu (3, "Purple-Blue shades", new int[][]{
    		 {0xECE7F2},
    		 {0xECE7F2, 0x2B8CBE},
   ...
   PuBuGn (3, "Purple-Blue-Green shades", new int[][]{
		     {0xECE2F0},
		     {0xECE2F0, 0x1C9099},
     ...
     PuRd (3, "Purple-Red shades", new int[][]{
    		 {0xE7E1EF},
    		 {0xE7E1EF, 0xDD1C77},
  ...
  Purples (3, "Purple shades", new int[][]{
		     {0xEFEDF5},
		     {0xEFEDF5, 0x756BB1},
     ...
     RdPu (3, "Red-Purple shades", new int[][] {
    		 {0xFDE0DD},
    		 {0xFDE0DD, 0xC51B8A},
     ...
     YlGn (3, "Yellow-Green shades", new int[][] {
    		 {0xF7FCB9},
    		 {0xF7FCB9, 0x31A354},
   ...
   YlGnBu (3, "Yellow-Green-Blue shades", new int[][] {
		     {0xEDF8B1},
		     {0xEDF8B1, 0x2C7FB8},
   ...
   YlOrBr (3, "Yellow-Orange-Brown shades", new int[][] {
		     {0xFFF7BC},
		     {0xFFF7BC, 0xD95F0E},
   ...
   YlOrRd (3, "Yellow-Orange-Red shades", new int[][] {
		     {0xFFEDA0},
		     {0xFFEDA0, 0xF03B20},
  ...
  hsvRdBl (1, "HSV Red-Blue", new int[][] {
		     {0xFF0000},
		     {0xFF0000, 0x0000FF},
  ...
  hsvCyMg (1, "HSV Red-Blue", new int[][] {
		     {0x00FFFF},
		     {0x00FFFF, 0xFF00FF},
	 ...
	 ColorBrewer(int paletteType, String paletteDescription, int[][] hexColors) {
	 ...
	 public static ColorBrewer[] getPalettes(int paletteType) {
