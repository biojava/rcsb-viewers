//  $Id: BondFormSplit.java,v 1.1 2007/02/08 02:38:51 jbeaver Exp $
//
...
//
//  Revision 1.1  2003/04/23 23:00:52  moreland
//  First version.
//
	...
	implements IBondForm
{
	...
	{
		if ( BondFormSplit.singleton == null ) {
			BondFormSplit.singleton = new BondFormSplit( );
		}
		return BondFormSplit.singleton;
	}
