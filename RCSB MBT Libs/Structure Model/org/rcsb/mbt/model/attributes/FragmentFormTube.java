//  $Id: FragmentFormTube.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
	...
	implements FragmentForm
{
	...
	{
		if ( FragmentFormTube.singleton == null ) {
			FragmentFormTube.singleton = new FragmentFormTube( );
		}
		return FragmentFormTube.singleton;
	}
