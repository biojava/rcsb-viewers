//  $Id: BondRadiusAsWire.java,v 1.1 2007/02/08 02:38:51 jbeaver Exp $
//
...
/**
 *  This class implements the BondRadius interface by applying a
	...
	implements IBondRadius
{
	 ...
	 */
	public static BondRadiusAsWire create( )
	{
		if ( BondRadiusAsWire.singleton == null ) {
			BondRadiusAsWire.singleton = new BondRadiusAsWire( );
		}
		return BondRadiusAsWire.singleton;
	}
