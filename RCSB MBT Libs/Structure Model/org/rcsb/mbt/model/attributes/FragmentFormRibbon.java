//  $Id: FragmentFormRibbon.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  Revision 1.1  2004/01/05 22:03:48  moreland
//  Added FragmentFormRibbon class.
//
//  Revision 1.0  2004/01/05 18:33:19  moreland
 ...
 *  ribbon style. A 3D representation would interconnect the first
 *  and last C-Alpha coordinates of the fragment with a simple ribbon
 *  shape.
 *  <P>
	...
	implements IFragmentForm
{
	 ...
	 */
	public static FragmentFormRibbon create( )
	{
		if ( FragmentFormRibbon.singleton == null ) {
			FragmentFormRibbon.singleton = new FragmentFormRibbon( );
		}
		return FragmentFormRibbon.singleton;
	}
	...
	{
		return FragmentFormRibbon.NAME;
	}
}
