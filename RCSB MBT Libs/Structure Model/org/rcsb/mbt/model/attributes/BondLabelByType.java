//  $Id: BondLabelByType.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
/**
 *  This class implements the BondLabel interface by producing a
 *  string label based upon the Bond's type.
 *  <P>
 *  @author	John L. Moreland
 *  @see	org.rcsb.mbt.model.attributes.IBondLabel
 *  @see	org.rcsb.mbt.model.Bond
 */
public class BondLabelByType
	implements IBondLabel
{
	public static final String NAME = "By Bond Type";

	// Holds a singleton instance of this class.
	private static BondLabelByType singleton = null;

	/**
	 *  The constructor is PRIVATE so that the "create" method
	 *  is used to produce a singleton instance of this class.
	 */
	private BondLabelByType( )
	{
	}
	 ...
	 */
	public static BondLabelByType create( )
	{
		if ( BondLabelByType.singleton == null ) {
			BondLabelByType.singleton = new BondLabelByType( );
		}
		return BondLabelByType.singleton;
	}

	/**
	 *  Produce a label based upon the bond type.
	 */
