//  $Id: AtomColor.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//  Initial commit
//
//  Revision 1.4  2004/04/09 00:12:51  moreland
...
/**
 *  This interface defines how all AtomColor implementation classes
 *  should generate a color for a given atomIndex+Atom.
 *  <P>
 *  @author	John L. Moreland
 *  @see	org.rcsb.mbt.model.StructureModel
 *  @see	org.rcsb.uiApp.controllers.update.IUpdateListener
 */
public interface IAtomColor
{
	public void getAtomColor( Atom atom, float[] color );
}
