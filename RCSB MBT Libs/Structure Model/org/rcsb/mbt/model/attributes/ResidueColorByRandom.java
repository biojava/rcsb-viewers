//$Id: ResidueColorByRandom.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: ResidueColorByRandom.java,v $
    ...
    implements IResidueColor
{
     ...
     */
    public static ResidueColorByRandom create( )
    {
        if ( ResidueColorByRandom.singleton == null ) {
			ResidueColorByRandom.singleton = new ResidueColorByRandom( );
		}

        return ResidueColorByRandom.singleton;
    }
