//  $Id: ResidueColorByAverageSideChainBFactor.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: ResidueColorByAverageSideChainBFactor.java,v $
//  Revision 1.1  2007/02/08 02:38:52  jbeaver
//  version 1.50
//
//  Revision 1.1  2006/10/04 17:21:06  jbeaver
 ...
 */
public class ResidueColorByAverageSideChainBFactor
	implements IResidueColor
{
	public static final String NAME = "By B Factor";

	// Holds a singleton instance of this class.
	private static ResidueColorByAverageSideChainBFactor singleton = null;
	 ...
	 */
	private ResidueColorByAverageSideChainBFactor( )
	{
	}
	 ...
	 */
	public static ResidueColorByAverageSideChainBFactor create( )
	{
		if ( ResidueColorByAverageSideChainBFactor.singleton == null ) {
			ResidueColorByAverageSideChainBFactor.singleton = new ResidueColorByAverageSideChainBFactor( );
		}
		return ResidueColorByAverageSideChainBFactor.singleton;
	}
	...
	{
		float bFactor = 0;
		if(residue.getAlphaAtom() != null) {
			bFactor = residue.getAlphaAtom().bfactor / 100f;
		}
//		Vector atoms = residue.getAtoms();
//		for(int i = 0; i < atoms.size(); i++) {
//			bFactor += ((Atom)atoms.get(i)).bfactor;
//		}
//		bFactor /= atoms.size();
