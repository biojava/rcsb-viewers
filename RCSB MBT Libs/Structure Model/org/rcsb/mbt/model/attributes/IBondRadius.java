//  $Id: BondRadius.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
/**
 *  This interface defines how all BondRadius implementation classes
 *  should provide a radius for a given Bond.
 *  <P>
 *  @author	John L. Moreland
 *  @see	org.rcsb.mbt.model.StructureModel
 *  @see	org.rcsb.mbt.controllers.update.IUpdateListener
 */
public interface IBondRadius
{
	/**
	 * Provides the primary radius for a bond.
	 */
	public float getBondRadius( Bond bond );

	/**
	 * Provides the secondary radius for a SPLIT bond (@see BondForm).
	 */
	public float getSplitBondRadius( Bond bond );
}
