//  $Id: BondColorByRgb.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
/**
 *  This class implements the BondColor interface using a fixed RGB color.
 *  <P>
 *  @author	John L. Moreland
 *  @see	org.rcsb.mbt.model.attributes.IAtomColor
 *  @see	org.rcsb.mbt.model.Atom
 */
public class BondColorByRgb
	implements IBondColor
{
	 ...
	 */
	public BondColorByRgb( final float[] color )
	{
		this.setColor( color );
	}
	 ...
	 *  and blue values.
	 */
	public BondColorByRgb( final float red, final float green, final float blue )
	{
		this.color[0] = red;
		this.color[1] = green;
		this.color[2] = blue;
	...
	/**
	 *  Produce a fixed color for the Bond.
	 */
	...
	/**
	 *  Set the fixed RGB color used to color a bond.
	 */
