//  $Id: AtomLabelByAtomElement.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: AtomLabelByAtomElement.java,v $
	...
	implements IAtomLabel
{
	...
	{
		if ( AtomLabelByAtomElement.singleton == null ) {
			AtomLabelByAtomElement.singleton = new AtomLabelByAtomElement( );
		}
		return AtomLabelByAtomElement.singleton;
	}
