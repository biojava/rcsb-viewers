//  $Id: BondColor.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  Revision 1.2  2003/04/23 23:09:27  moreland
...
/**
 *  This interface defines how all BondColor implementation classes
 *  should fill in a color for a given atomIndex+Atom.
 *  <P>
 *  @author	John L. Moreland
 *  @see	org.rcsb.mbt.model.StructureModel
 *  @see	org.rcsb.mbt.controllers.update.IUpdateListener
 */
public interface IBondColor
{
	/**
	 * Provides the primary color for a bond.
	 */
	public void getBondColor( Bond bond, float[] color );

	/**
	 * Provides the secondary color for a SPLIT bond (@see BondForm).
	 */
	public void getSplitBondColor( Bond bond, float[] color );
}
