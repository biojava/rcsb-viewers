//  $Id: AtomColorByResidueColor.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: AtomColorByResidueColor.java,v $
...
//
//  Revision 1.3  2004/04/09 00:12:51  moreland
...
//
//  Revision 1.0  2003/12/18 18:33:19  moreland
//  First implementation.
//
	...
	implements IAtomColor
{
	 ...
	 */
	public static AtomColorByResidueColor create( )
	{
		if ( AtomColorByResidueColor.singleton == null ) {
			AtomColorByResidueColor.singleton = new AtomColorByResidueColor( );
		}
		return AtomColorByResidueColor.singleton;
	}

	/**
	 *  Produce a color based upon the residue color.
	 */
	public void getAtomColor( final Atom atom, final float[] color )
	{
		...
		final Chain c = structureMap.getChain(atom);
		final StructureStyles structureStyles = structureMap.getStructureStyles( );
		final ChainStyle residueStyle =
			(ChainStyle) structureStyles.getStyle( c );
		residueStyle.getResidueColor( residue, color );
	}
}
