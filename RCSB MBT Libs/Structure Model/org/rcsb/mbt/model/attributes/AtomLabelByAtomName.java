//  $Id: AtomLabelByAtomName.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: AtomLabelByAtomName.java,v $
 ...
 *  string label from the Atom record's name.
 *  <P>
...
{
	public static final String NAME = "By Atom Name";

	// Holds a singleton instance of this class.
	private static AtomLabelByAtomName singleton = null;

	/**
	 *  The constructor is PRIVATE so that the "create" method
	 *  is used to produce a singleton instance of this class.
	 */
	private AtomLabelByAtomName( )
	{
	}
	...
	{
		if ( AtomLabelByAtomName.singleton == null ) {
			AtomLabelByAtomName.singleton = new AtomLabelByAtomName( );
		}
		return AtomLabelByAtomName.singleton;
	}
