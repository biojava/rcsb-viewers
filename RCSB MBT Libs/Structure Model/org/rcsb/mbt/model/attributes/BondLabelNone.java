//  $Id: BondLabelNone.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
	...
	implements IBondLabel
{
	...
	{
		if ( BondLabelNone.singleton == null ) {
			BondLabelNone.singleton = new BondLabelNone( );
		}
		return BondLabelNone.singleton;
	}
