//  $Id: ResidueColorByResidueIndex.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: ResidueColorByResidueIndex.java,v $
	...
	implements IResidueColor
{
	...
	private InterpolatedColorMap colorMap =
		new InterpolatedColorMap( InterpolatedColorMap.MOLSCRIPT_RAMP );
	...
	{
		if ( ResidueColorByResidueIndex.singleton == null ) {
			ResidueColorByResidueIndex.singleton = new ResidueColorByResidueIndex( );
		}
		return ResidueColorByResidueIndex.singleton;
	}
	...
	{
		final StructureMap structureMap = residue.getStructure().getStructureMap( );
