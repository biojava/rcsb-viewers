//  $Id: AtomRadiusByConstant.java,v 1.1 2007/02/08 02:38:52 jbeaver Exp $
//
...
//
//  History:
//  $Log: AtomRadiusByConstant.java,v $
...
{
	public static final String NAME = "By Constant (Smooth Bonds)";

	// The constant radius to use.
	private float radius = 0.2f;

	// Holds a singleton instance of this class.
	private static AtomRadiusByConstant singleton = null;

	/**
	 *  The constructor is PRIVATE so that the "create" method
	 *  is used to produce a singleton instance of this class.
	 */
	private AtomRadiusByConstant( )
	{
	}
	...
	{
		if ( AtomRadiusByConstant.singleton == null ) {
			AtomRadiusByConstant.singleton = new AtomRadiusByConstant( );
		}
		return AtomRadiusByConstant.singleton;
	}
