//
// CifParseException.java,v 1.3 2001/10/27 02:02:47 dsg Exp
//
...
public class CifParseException extends Exception
{
  /**
	 * 
	 */
	private static final long serialVersionUID = -8383578082217073086L;

public CifParseException(final String msg)
    {
      super(msg);
    }
}
